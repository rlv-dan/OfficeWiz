...
'64 bit? added for Flash Renamer
...
Public Function IsWin7() As Boolean
   ...
   If GetVersionEx(osv) = 1 Then
      ...
      IsWin7 = (osv.PlatformID = VER_PLATFORM_WIN32_NT) And _
                (osv.dwVerMajor = 6 And osv.dwVerMinor = 1)

   End If
   
End Function

Public Function IsWin7Plus() As Boolean
   ...
   If GetVersionEx(osv) = 1 Then
      ...
      IsWin7Plus = (osv.PlatformID = VER_PLATFORM_WIN32_NT) And _
                    ((osv.dwVerMajor = 6 And osv.dwVerMinor >= 1) Or osv.dwVerMajor > 6)
